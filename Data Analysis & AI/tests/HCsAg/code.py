def is_HBsAG(value:str)->str:
    ...
    if value in words_of_good_test_results:
        return "Indicates the absence of the Hepatitis C Surface Antigen in the blood"
    if value in words_of_bad_test_results:
        return "Indicates the presence of the Surface Antigen, meaning there is an active Hepatitis C infection (either acute or chronic)."
